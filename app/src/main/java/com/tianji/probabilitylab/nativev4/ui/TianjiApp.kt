...
fun TianjiApp() {
    ...
    BackHandler(enabled = destination != NavDestination.FORECAST) { destination = NavDestination.FORECAST }
                ...
                Box(
                    ...
                    AnimatedContent(
                        ...
                        when (page) {
                            ...
                            NavDestination.ROLLING -> RollingScreen(state, controller::selectLottery, Modifier.fillMaxSize())
                            NavDestination.EVIDENCE -> EvidenceScreen(state, controller::selectLottery, Modifier.fillMaxSize())
                            NavDestination.ARCHIVE -> ArchiveScreen(state, controller::selectLottery, Modifier.fillMaxSize())
                            NavDestination.DATA -> DataScreen(
                                state = state,
                                paletteMode = paletteMode,
                                aiConfigs = controller.aiConfigs,
                                aiAvailableModels = controller.aiAvailableModels,
                                onPaletteChanged = { mode -> scope.launch { appearance.setPalette(mode) } },
                                onSelectLottery = controller::selectLottery,
